...
export function getPartyNameByPartyCode(districtResult: DistrictResult, partyCode: string) {
    const partyResult = districtResult.partyResults.find((pr) => pr.partyCode === partyCode)!;
    return partyResult.partyName;
}
