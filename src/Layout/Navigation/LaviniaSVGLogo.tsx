...
export interface LaviniaSVGLogoProps {
  ...
  height={this.props.height}
     width="100%"
       ...
       >
    <text filter="invert(100%)" x="54" y="34" font-size={this.props.fontSize}>{this.props.title}</text>
  <g transform="translate(-32.831 -75.101)">
  <g>
  <g fill={this.props.color} stroke={this.props.color} stroke-width=".26458px">
